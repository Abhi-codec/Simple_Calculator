...
def calculate_date1():
    ...
    lbl_from_date = Label(root, text="From Date  (dd/mm/yy)")
    lbl_from_date.place(relx=0.1, rely=0.1)

    lbl_to_date = Label(root, text="To Date  (dd/mm/yy)")
    lbl_to_date.place(relx=0.1, rely=0.2)

    lbl_total = Label(root, text="Calculated Date(dd/mm/yy)")
...
def circle_calc1():
    ...
    lbl_radius = Label(circle, text="Enter your radius    (in cm)")
...
def cylinder_calc1():
    ...
    lbl_height = Label(cylinder, text="Enter your Radius  (in cm)")
    lbl_height.place(relx=0.1, rely=0.1)

    lbl_radius = Label(cylinder, text="Enter your Height  (in cm)")
    lbl_radius.place(relx=0.1, rely=0.2)
...
def cube_calc1():
    ...
    lbl_length = Label(cube, text="Enter your Length  (in cm)")
    lbl_length.place(relx=0.1, rely=0.1)

    lbl_breadth = Label(cube, text="Enter your Breadth  (in cm)")
    lbl_breadth.place(relx=0.1, rely=0.2)

    lbl_height = Label(cube, text="Enter your Height  (in cm)")
...
def help():
    ...
    lbl = Label(root, text="Calculator - HELP\n\n\n"
                           ...
                           "Brackets does not act as an operator of \n multiplication if brackets are use dont forget to use operatos before and after if needed")
